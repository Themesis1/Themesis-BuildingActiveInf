...
#===================================================================================================
# SECTION 7: WHY ACTIVE INFERENCE? THE MONTE CARLO ARGUMENT
#===================================================================================================

print("\n" + "="*60)
print("WHY ACTIVE INFERENCE? THE MONTE CARLO ARGUMENT")
print("="*60)
print()
...
print("This is plain Monte Carlo estimation -- repeated random trials")
print("of a chain (our B matrix) we already fully know.")
print()
print("For our 5-node world, Monte Carlo works fine.")
print()
print("But real-world systems have millions or billions of states.")
print("Running enough trials to converge becomes computationally intractable.")
print()
...
print("brute-force sampling is too slow. Variational inference is the solution.")
